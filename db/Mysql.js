...
app.post('/ages', function(req, res) {
  ...
  execSQLQuery('SELECT a.table_name, b.table_name, SUBSTRING(a.table_name, 23, 9) as "idades", SUBSTRING(a.table_name, 14, 3) as "mes" FROM information_schema.tables a, information_schema.tables b WHERE a.table_schema = "datasaude" and a.table_schema = b.table_schema and a.table_name like "%fem%" and b.table_name like "%masc%" and SUBSTRING(a.table_name, 23, 9) = SUBSTRING(b.table_name, 23, 9) and SUBSTRING(a.table_name, 14, 3) = SUBSTRING(b.table_name, 14, 3)', res); 
})
